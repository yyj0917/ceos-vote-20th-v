...
export default function DemodayLayout({
  ...
  useEffect(() => {
    // pathname에 따라 진행도 결정
    if (pathname === "/main/vote/demoday") {
      setProgress(33);
    } else if (pathname === "/main/vote/demoday/step2") {
      setProgress(66);
    } else if (pathname === "/main/vote/demoday/step3") {
      setProgress(100);
    } else {
  ...
  return (
    <div className="px-6 py-6 w-full h-full">
        <div className="w-full flex flex-col items-center">
            {/* Header */}
            <Header title="데모데이 투표" className="text-logo py-6"/>
            {/* Bar */}
